...
if [[ ! -z $REPLACER_EXTENSION_ID ]]; then
  sed -i 's|'"$EXTENSION_ID_STRING_MATCHER_START"'.*'"$EXTENSION_ID_STRING_MATCHER_END"'|'"$EXTENSION_ID_STRING_MATCHER_START$REPLACER_EXTENSION_ID$EXTENSION_ID_STRING_MATCHER_END"'|' $PATH_TO_FILE_WITH_EXTENSION_ID1
  sed -i 's|'"$EXTENSION_ID_STRING_MATCHER_START"'.*'"$EXTENSION_ID_STRING_MATCHER_END"'|'"$EXTENSION_ID_STRING_MATCHER_START$REPLACER_EXTENSION_ID$EXTENSION_ID_STRING_MATCHER_END"'|' $PATH_TO_FILE_WITH_EXTENSION_ID2
  sed -i 's|'"$EXTENSION_ID_STRING_MATCHER_START"'.*'"$EXTENSION_ID_STRING_MATCHER_END"'|'"$EXTENSION_ID_STRING_MATCHER_START$REPLACER_EXTENSION_ID$EXTENSION_ID_STRING_MATCHER_END"'|' $PATH_TO_FILE_WITH_EXTENSION_ID3
fi
