...
{
  let paths = [
    "icons/blade/blade-16.png", "icons/blade/blade-16-whitelisted.png",
    "icons/blade/blade-32.png", "icons/blade/blade-32-whitelisted.png"
  ];
  ...
  for (let path of paths)
  {
    ...
    {
      let [, size, whitelisted] = /\/blade-(16|32)(-whitelisted)?\./.exec(path);
  ...
  if (!notificationType || !frames)
  {
    ...
    else
    {
      page.browserAction.setIconPath(
        "/icons/blade/blade-$size" + (whitelisted ? "-whitelisted" : "") + ".png"
      );
    }
  }
  else
...
function renderFrames(notificationType)
{
  ...
  return Promise.all([
    ...
    loadImage("icons/blade/blade-16-whitelisted.png"),
    loadImage("icons/blade/blade-20.png"),
    loadImage("icons/blade/blade-20-whitelisted.png"),
    loadImage("icons/blade/blade-32.png"),
    loadImage("icons/blade/blade-32-whitelisted.png"),
    loadImage("icons/blade/blade-40.png"),
    loadImage("icons/blade/blade-40-whitelisted.png")
  ]).then(images =>
  {
    let imageMap = {
      16: {base: [images[0], images[1]]},
      20: {base: [images[2], images[3]]},
      32: {base: [images[4], images[5]]},
      40: {base: [images[6], images[7]]}
    };
